...
<template>
    ...
    <div class="container">
      <div class="card">
        <div class="shoeBackground">
          ...
          <img src="blue.png" alt="" class="shoe show" color="blue" />
          <img src="red.png" alt="" class="shoe" color="red" />
          <img src="green.png" alt="" class="shoe" color="green" />
          <img src="orange.png" alt="" class="shoe" color="orange" />
          <img src="black.png" alt="" class="shoe" color="black" />
        </div>
        <div class="info">
          <div class="shoeName">
            <div>
          ...
          <div class="description">
            ...
            <p class="text">
              ...
              industry. Lorem Ipsum has the industry's.
            </p>
          </div>
          <div class="color-container">
            ...
            <div class="colors">
              <span
                ...
                :key="color.color"
                :class="{ color: true, active: color.color === prevColor }"
                :style="{ backgroundColor: color.primary }"
                @click="changeColor(color.color, color.primary)"
              ></span>
            </div>
          </div>
          <div class="size-container">
            ...
            <div class="sizes">
              <span
                v-for="size in sizes"
                :key="size"
                :class="{ size: true, active: size === prevSize }"
  ...
  export default {
    ...
    mounted() {
      this.shoes = document.querySelectorAll(".shoe");
      this.gradients = document.querySelectorAll(".gradient");
      this.shoeBg = document.querySelector(".shoeBackground");
      this.x = window.matchMedia("(max-width: 991.98px)");
      this.changeHeight();
    ...
    methods: {
      ...
      changeColor(color, primary) {
        ...
        let prevGradient = document.querySelector(`.gradient[color="${this.prevColor}"]`);
  
        if (color == this.prevColor) return;
  
        this.colors.forEach((c) => (c.active = c.color === color));
        document.documentElement.style.setProperty("--primary", primary);
  
        this.shoes.forEach((s) => s.classList.remove("show"));
      ...
      changeHeight() {
        if (this.x.matches) {
          let shoeHeight = this.shoes[0].offsetHeight;
          this.shoeBg.style.height = `${shoeHeight * 0.9}px`;
        } else {
          this.shoeBg.style.height = "475px";
        }
      },
    },
    destroyed() {
